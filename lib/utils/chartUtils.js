...
var determineXScale = exports.determineXScale = function determineXScale(_ref) {
  ...
  switch (type) {
    ...
    case 'linear':
      return (0, _d3Scale.scaleLinear)().domain([(0, _lodash.head)(sortedX), (0, _lodash.last)(sortedX)]).range(range);
    default:
      return (0, _d3Scale.scaleTime)().domain([(0, _lodash.head)(sortedX), (0, _lodash.last)(sortedX)]).range(range);
  }
};
