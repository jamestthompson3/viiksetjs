...
exports.barChart = exports.biaxial = exports.findTooltipX = exports.determineViewBox = exports.determineYScale = exports.determineXScale = undefined;
...
var barChart = exports.barChart = function barChart(children) {
  return children && _react.Children.map(children, function (child) {
    return child.type.name === 'BarChart' || child.type.name === 'StackedBar';
  }).includes(true);
};
/**
