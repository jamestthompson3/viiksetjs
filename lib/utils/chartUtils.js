...
exports.biaxial = exports.findTooltipX = exports.determineYScale = exports.determineXScale = exports.recursiveCloneChildren = undefined;
 ...
 */
var recursiveCloneChildren = exports.recursiveCloneChildren = function recursiveCloneChildren(children, props) {
...
var determineXScale = exports.determineXScale = function determineXScale(_ref) {
  ...
  var sortedX = xPoints.sort(function (a, b) {
    return a - b;
  });
  ...
  switch (type) {
    ...
    case 'linear':
      return (0, _d3Scale.scaleLinear)().domain([(0, _head2.default)(sortedX), (0, _last2.default)(sortedX)]).range(range);
    default:
      return (0, _d3Scale.scaleTime)().domain([(0, _head2.default)(sortedX), (0, _last2.default)(sortedX)]).range(range);
  }
};
...
var determineYScale = exports.determineYScale = function determineYScale(_ref2) {
  ...
  switch (type) {
    ...
    case 'linear':
      return orientation === 'horizontal' ? (0, _d3Scale.scaleBand)().domain(yPoints).range([height, margin.top]).padding(0.1) : (0, _d3Scale.scaleLinear)().domain([0, Math.max.apply(Math, _toConsumableArray(yPoints))]).range(range);
    default:
...
var biaxial = exports.biaxial = function biaxial(children) {
  return children && _react.Children.map(children, function (child) {
    return (0, _react.isValidElement)(child) && child.props.hasOwnProperty('axisId');
  }).includes(true);
};
