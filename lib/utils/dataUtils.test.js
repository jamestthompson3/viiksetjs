...
describe('Data Utilties', function () {
  describe('manipulate data', function () {
    ...
    it('takes an array of objects and a datakey and returns an array of x-value points', function () {
      expect(data.getX([{ users: 33350.0, servers: 2091.0, time: '2017-11-06T02:00:00.000+02' }, { users: 32974.0, servers: 2085.0, time: '2017-11-06T02:05:00.000+02' }])).toEqual([new Date('2017-11-06T00:00:00.000Z'), new Date('2017-11-06T00:05:00.000Z')]);
      expect(data.getX([{ x: 223, y: 14 }, { x: 334, y: 233 }, { x: 110, y: 2 }], 'x')).toEqual([223, 334, 110]);
      expect(data.getX([{ x: { users: 223 }, y: 14 }, { x: { users: 334 }, y: 233 }, { x: { users: 110 }, y: 2 }], 'x.users')).toEqual([223, 334, 110]);
    });
    ...
    it('takes a data object and extracts all X values', function () {
      expect(data.extractX({ users: 2231, time: '2017-11-06T02:00:00.000+02' })).toEqual([new Date('2017-11-06T00:00:00.000Z')]);
