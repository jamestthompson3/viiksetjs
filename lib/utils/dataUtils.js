...
var extractY = exports.extractY = function extractY(datum, yKey) {
  return yKey ? [datum[yKey]] : (0, _lodash.flatten)(parseObject(datum, 'number')).filter(function (i) {
    return i != null;
  });
};
...
var extractX = exports.extractX = function extractX(datum, xKey) {
  return xKey ? [datum[xKey]] : (0, _lodash.flatten)(parseObject(datum, 'string')).filter(function (i) {
    return i != null;
  }).map(function (i) {
