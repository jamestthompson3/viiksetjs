 ...
 */
var parseObject = exports.parseObject = function parseObject(object, arg, applicator) {
  return Object.values(object).map(function (value) {
    return applicator ? applicator(value) : value;
...
var getX = exports.getX = function getX(data, xKey) {
  return xKey ? data.map(function (datum) {
    return (0, _get2.default)(datum, xKey);
  }) : (0, _flatten2.default)(data.map(function (datum) {
...
var getY = exports.getY = function getY(data, yKey) {
  return yKey ? data.map(function (datum) {
    return (0, _get2.default)(datum, yKey);
  }) : (0, _flatten2.default)(data.map(function (datum) {
...
var extractY = exports.extractY = function extractY(datum, yKey) {
  return yKey ? [(0, _get2.default)(datum, yKey)] : (0, _flatten2.default)(parseObject(datum, 'number'));
};
...
var extractX = exports.extractX = function extractX(datum, xKey) {
  return xKey ? [(0, _get2.default)(datum, xKey)] : (0, _flatten2.default)(parseObject(datum, 'string')).map(function (i) {
    return new Date(checkMoment(i));
  });
};
...
var extractLabels = exports.extractLabels = function extractLabels(datum) {
  return (0, _flatten2.default)(Object.entries(datum).map(function (value) {
    if (typeof (0, _last2.default)(value) === 'number') {
