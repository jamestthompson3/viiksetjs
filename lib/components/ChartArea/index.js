  ...
  function ChartArea() {
    ...
    return (
      (_ret = ((_temp = ((_this = _possibleConstructorReturn(
        this,
        (_ref = ChartArea.__proto__ || Object.getPrototypeOf(ChartArea)).call.apply(
          _ref,
          [this].concat(args)
        )
      )),
      ...
      (_this.calculateData = function() {
        ...
        var yScale = scaleLinear()
          .domain([0, Math.max.apply(Math, _toConsumableArray(yPoints))])
        ...
        return (
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                !nogrid &&
                  React.createElement(
                    StyledGridRows,
                    _extends({ scale: yScale }, { stroke: stroke }, { width: width - margin.left })
                  ),
                biaxialChildren ||
                  React.createElement(StyledLeftAxis, {
                    scale: yScale,
                    color: color,
                    hideTicks: true,
                    tickFormat: formatY
            ...
            x &&
              React.createElement(
                Tooltip,
                _extends({ tooltipData: calculatedData }, { x: x, color: color, yCoords: yCoords })
              )
          )
        )
      }
