...
import { determineXScale, biaxial, localPoint, determineViewBox, determineYScale, barChart } from '../../utils/chartUtils';
...
var ChartArea = function (_Component) {
  ...
  function ChartArea() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ChartArea.__proto__ || Object.getPrototypeOf(ChartArea)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var yScales = biaxialChildren && createScalarData(data, dataKeys, height, margin);
      ...
      flow(function (xValue) {
        ...
        var x = xScale(head(extractX(calculatedData, xKey)));
      ...
      return chartData && React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            Group,
            { left: margin.left },
            barChart(children) || React.createElement(Bar, {
          ...
          x && !barChart(children) && React.createElement(Indicator, { yCoords: yCoords, x: x, stroke: stroke, color: color, height: height, mouseX: mouseX })
        ),
        x && React.createElement(Tooltip, _extends({ tooltipData: calculatedData }, { x: x, color: color, yCoords: yCoords, mouseX: mouseX, height: height }))
      );
    }
  }]);
