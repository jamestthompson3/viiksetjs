...
import { getX, getY, extractLabels, extractX, extractY, createScalarData } from 'common/vx/utils/dataUtils';
      ...
      return chartData && React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(GridRows, {
              lineStyle: { pointerEvents: 'none' },
              scale: yScale,
              width: width - margin.left,
              stroke: stroke
            }),
            biaxialChildren || React.createElement(AxisLeft, {
              scale: yScale,
              numTicks: 4,
              stroke: color,
              strokeWidth: 2,
        ...
        x && React.createElement(Tooltip, { tooltipData: calculatedData, left: x, color: color })
      );
    }
  }]);
