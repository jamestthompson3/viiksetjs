...
var ChartArea = function (_Component) {
  ...
  function ChartArea() {
    ...
    }, _this.mouseMove = function (event, datum) {
  ...
  _createClass(ChartArea, [{
    ...
    value: function render() {
      ...
      var Tooltip = tooltipRenderer && (0, _styledComponents.withBounds)(tooltipRenderer);
      ...
      return chartData && _react2.default.createElement(
        ...
        x ? Tooltip ? _react2.default.createElement(Tooltip, {
          ...
          _styledComponents.TooltipComponent,
          { color: color, tooltipData: calculatedData, x: x },
          tooltipContent
        ) : null
      );
    }
