    ...
    value: function render() {
      ...
      return !chartData ? _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          biaxialChildren || _react2.default.createElement(_index.StyledLeftAxis, {
            scale: (0, _chartUtils.determineYScale)({ type: null, yPoints: yPoints, height: height, margin: margin }),
            color: color,
            numTicks: numYTicks,
            hideTicks: true,
            tickFormat: formatY,
