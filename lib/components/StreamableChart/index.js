  ...
  function StreamableChart() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = StreamableChart.__proto__ || Object.getPrototypeOf(StreamableChart)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      _this.socket.onclose = function () {
        return console.warn('connection closed');
      };
  ...
  _createClass(StreamableChart, [{
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          determineViewBox = _props2.determineViewBox,
          data = _props2.data,
      ...
      return !chartData ? _react2.default.createElement(
        ...
        'svg',
        {
          ...
          viewBox: determineViewBox ? determineViewBox({ size: size, margin: margin }) : '-10 0 ' + size.width + ' ' + height,
        ...
        _react2.default.createElement(
          _group.Group,
          { left: margin.left },
          !nogrid && _react2.default.createElement(_index.StyledGridRows, _extends({
            scale: yScale
          }, { stroke: stroke }, {
          ...
          }, { color: color, numTicks: numYTicks, tickLabelProps: yTickLabelProps }, {
            hideTicks: true,
            tickFormat: formatY,
            label: labelY || '',
        ...
        _react2.default.createElement(_index.StyledBottomAxis, _extends({
          scale: xScale
        }, { color: color, height: height, margin: margin, numTicks: numXTicks, tickLabelProps: xTickLabelProps }, {
          hideTicks: true,
          tickFormat: formatX,
          label: labelX || '',
