  ...
  _createClass(StackedBar, [{
    ...
    value: function render() {
      ...
      var yPoint = function yPoint(d) {
        return yScale((0, _lodash.get)(d, yKey));
      };
          ...
          return _react2.default.createElement(
            ...
            s.map(function (d, ii) {
              ...
              return _react2.default.createElement(_styledComponents.StyledBar, _extends({
                ...
                x: isHorizontal ? xScale(d[0]) : xPoint((0, _lodash.get)(d, 'data')),
                y: isHorizontal ? yPoint((0, _lodash.get)(d, 'data')) : height + margin.top - yScale(d[1]),
                ...
                onMouseMove: function onMouseMove() {
                  return function (event) {
                    var key = s.key;
                    var datum = (0, _lodash.set)({}, xKey || 'xValue', (0, _lodash.head)((0, _dataUtils.extractX)((0, _lodash.get)(d, 'data'), xKey)));
                    (0, _lodash.set)(datum, key, (0, _lodash.get)(d, 'data.' + key));
