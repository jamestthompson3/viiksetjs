...
var BarChart = function BarChart(_ref) {
  var data = _ref.data,
      ...
      rest = _objectWithoutProperties(_ref, ['data', 'color', 'dataKey', 'xScale', 'xKey', 'margin', 'height', 'fill', 'inheritedScale']);
  ...
  var yMax = height - margin.bottom;
  var barHeight = function barHeight(d) {
    return inheritedScale(d[dataKey]) - margin.top;
  };
  return React.createElement(
    Fragment,
    null,
    React.createElement(LinearGradient, { from: rgba(color, 0.35), to: rgba(color, 0.05), id: 'gradient' + xKey }),
