...
var StyledLeftAxis = exports.StyledLeftAxis = (0, _styledComponents2.default)(_axis.AxisLeft).attrs({
  ...
  tickLabelProps: function tickLabelProps(p) {
    return propsColorSetter(p.tickLabelProps, p);
  },
...
var StyledThreshold = exports.StyledThreshold = (0, _styledComponents2.default)(_threshold.Threshold).attrs({
  belowAreaProps: function belowAreaProps(p) {
    return colorSetter(p.belowAreaProps, p);
  },
  aboveAreaProps: function aboveAreaProps(p) {
    return colorSetter(p.aboveAreaProps, p);
  }
})(_templateObject2);
