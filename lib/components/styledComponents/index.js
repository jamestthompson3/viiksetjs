...
var propsColorSetter = function propsColorSetter(func, p) {
  ...
  var fill = findFill(combinedProps);
  var labelProps = function labelProps() {
...
var StyledBar = exports.StyledBar = (0, _styledComponents.withTheme)(function (props) {
  return _react2.default.createElement(_shape.Bar, _extends({}, props, { stroke: findColor(props) }));
});
...
var StyledGradient = exports.StyledGradient = (0, _styledComponents.withTheme)(function (props) {
  return _react2.default.createElement(_gradient.LinearGradient, _extends({}, props, {
    from: (0, _polished.rgba)(findColor(props), props.startOpacity),
    to: (0, _polished.rgba)(findColor(props), props.endOpacity)
  }));
});
