...
var propsColorSetter = function propsColorSetter(p) {
  switch (true) {
    case (0, _lodash.get)(p, 'stroke'):
      return (0, _lodash.set)(p, 'stroke', findStroke(p));
    case (0, _lodash.get)(p, 'fill'):
      return (0, _lodash.set)(p, 'fill', findFill(p));
    case (0, _lodash.get)(p, 'color'):
      return (0, _lodash.set)(p, 'color', findColor(p));
    default:
      return p;
  }
};
