...
export var TooltipContainer = styled.div.attrs({
...
// }
var TooltipBucket = function TooltipBucket(_ref2) {
  var children = _ref2.children,
    getRects = _ref2.getRects,
    color = _ref2.color,
    left = _ref2.left
  ...
  return React.createElement(TooltipContainer, { bounds: getBounds() }, children)
}

export var BoundedTooltip = withBoundingRects(TooltipBucket)

export var TooltipComponent = function TooltipComponent(_ref3) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      Object.entries(tooltipData).map(function(entry, i) {
        return React.createElement('p', { key: i }, entry[0] + ': ' + entry[1])
      })
    )
  )
}

export var Indicator = function Indicator(_ref4) {
  var yCoords = _ref4.yCoords,
    x = _ref4.x,
    stroke = _ref4.stroke,
    color = _ref4.color
  return React.createElement(
