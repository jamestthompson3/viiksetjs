...
var findColor = exports.findColor = function findColor(p) {
  return p.theme && p.theme[p.color] || p.color || p.theme.primaryColor;
};
...
var propsColorSetter = function propsColorSetter(func, p, value, index) {
  ...
  var fill = (0, _get2.default)(combinedProps, 'fill') ? findFill(combinedProps) : findColor(combinedProps);
...
var colorSetter = function colorSetter(formatProps, p) {
  /* eslint-disable */
  switch (true) {
    case (0, _get2.default)(formatProps, 'color') != null:
      return _extends({}, formatProps, { stroke: findColor(p), fill: findColor(p) });
    case (0, _get2.default)(formatProps, 'stroke') != null:
      return _extends({}, formatProps, { stroke: findStroke(p), fill: findStroke(p) });
    case (0, _get2.default)(formatProps, 'fill') != null:
...
var StyledGradient = exports.StyledGradient = (0, _styledComponents.withTheme)(function (props) {
  return _react2.default.createElement(_gradient.LinearGradient, _extends({}, props, {
    from: (0, _polished.rgba)(findColor(props), props.opacity ? props.opacity[0] : props.start),
    to: (0, _polished.rgba)(findColor(props), props.opacity ? props.opacity[1] : props.end)
  }));
});
...
var StyledAreaClosed = exports.StyledAreaClosed = (0, _styledComponents.withTheme)(function (props) {
  return _react2.default.createElement(_shape.AreaClosed, _extends({}, props, { stroke: findColor(props), fill: findFill(props) }));
});
...
var StyledThreshold = exports.StyledThreshold = (0, _styledComponents.withTheme)(function (props) {
  return _react2.default.createElement(_threshold.Threshold, _extends({}, props, {
    belowAreaProps: colorSetter(props.belowAreaProps, _extends({}, props, props.belowAreaProps)),
    aboveAreaProps: colorSetter(props.aboveAreaProps, _extends({}, props, props.aboveAreaProps))
  }));
});
