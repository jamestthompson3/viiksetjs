...
var propsColorSetter = function propsColorSetter(func, p) {
  ...
  switch (true) {
    case (0, _lodash.get)(p, 'color') != null:
      return function () {
        return (0, _lodash.set)(exec, 'stroke', findColor(p));
      };
    case (0, _lodash.get)(p, 'stroke') != null:
      return function () {
        return (0, _lodash.set)(exec, 'stroke', findStroke(p));
      };
    default:
      return function () {
        return (0, _lodash.set)(exec, 'stroke', findColor(p));
...
var StyledLeftAxis = exports.StyledLeftAxis = (0, _styledComponents2.default)(_axis.AxisLeft).attrs({
  ...
  tickLabelProps: function tickLabelProps(p) {
    return p.tickLabels ? propsColorSetter(p.tickLabels, p) : function () {
      return { fill: findColor(p), dx: '-2em' };
    };
  },
  labelProps: function labelProps(p) {
    return function () {
      return propsColorSetter(p.labelProps, p) || { fill: findColor(p), dx: '-2em' };
    };
  }
})(_templateObject);
var StyledRightAxis = exports.StyledRightAxis = (0, _styledComponents2.default)(_axis.AxisRight).attrs({
  ...
  tickLabelProps: function tickLabelProps(p) {
    return p.tickLabels ? propsColorSetter(p.tickLabels, p) : function () {
      return { fill: findColor(p) };
    };
  },
  labelProps: function labelProps(p) {
    return function () {
      return propsColorSetter(p.labelProps, p) || { fill: findColor(p) };
    };
  }
})(_templateObject);
var StyledBottomAxis = exports.StyledBottomAxis = (0, _styledComponents2.default)(_axis.AxisBottom).attrs({
  ...
  labelProps: function labelProps(p) {
    return function () {
      return propsColorSetter(p.labelProps) || { fill: findColor(p), dx: '-2em' };
    };
  }
})(_templateObject);
...
var Corner = exports.Corner = _styledComponents2.default.div(_templateObject3, function (p) {
  return p.color || p.theme.primaryColor;
}, function (p) {
  return p.color || p.theme.primaryColor;
});
