...
var TooltipComponent = function TooltipComponent(_ref3) {
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_styledComponents3.StyledPie, {
              ...
              centroid: function centroid(_centroid2, arc) {
                ...
                return _react2.default.createElement(Label, { x: x, y: y, labelText: data[labelKey] });
              }
            })
          )
        ),
        mouseX && _react2.default.createElement(Tooltip, _extends({ tooltipData: calculatedData }, { mouseX: mouseX, color: color, mouseY: mouseY, height: height, width: width }))
      );
    }
  }]);
...
PieChart.propTypes = {
   ...
   */
  determineOpacity: _propTypes2.default.function,
  /**
   * innerRadius offset
   */
...
PieChart.defaultProps = {
  determineOpacity: function determineOpacity(d) {
    return 0.5;
  },
