  ...
  _createClass(ScatterPlot, [{
    ...
    value: function render() {
      ...
      if (data.map(function (item) {
        ...
        process.env.NODE_ENV !== 'production' && console.warn('ScatterPlot: No data found with dataKey ' + dataKey);
        return null;
      }
      ...
      if (axisId && data.map(function (item) {
        ...
        // eslint-disable-next-line
        process.env.NODE_ENV !== 'production' && console.warn('ScatterPlot: No data found with axisId ' + axisId);
        return null;
      }
