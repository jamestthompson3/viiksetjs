  ...
  _createClass(LineChart, [{
    ...
    value: function render() {
      ...
      var xPoints = function xPoints(d) {
        return xKey ? d[xKey] : new Date((0, _dataUtils.parseObject)(d, 'string', _dataUtils.checkMoment));
      };
      ...
      var findFill = function findFill(gradient) {
        return nofill || gradient ? 'url(#gradient' + dataKey + ')' : 'url(#dlines' + dataKey + ')';
      };
      ...
      return _react2.default.createElement(
        ...
        !nofill && _react2.default.createElement(
          _react.Fragment,
          null,
          _react2.default.createElement(_styledComponents.StyledGradient, _extends({ color: color }, { id: 'gradient' + dataKey })),
          _react2.default.createElement(_styledComponents.StyledPatternLines, _extends({ color: color }, { id: 'dlines' + dataKey }))
        ),
