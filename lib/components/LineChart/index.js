    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        pattern && React.createElement(
          Fragment,
          null,
          React.createElement(StyledGradient, { color: color, dataKey: dataKey }),
          React.createElement(StyledPatternLines, { color: color, dataKey: dataKey })
        ),
        React.createElement(StyledLinePath, { data: data, xScale: xScale, yScale: yScale, inheritedScale: inheritedScale, xPoints: xPoints, yPoints: yPoints, color: color, axisId: axisId }),
