  ...
  _createClass(LineChart, [{
    ...
    value: function render() {
      ...
      if (data.map(function (item) {
        ...
        process.env.NODE_ENV !== 'production' && console.warn('LineChart: No data found with dataKey ' + dataKey);
        return null;
      }
      ...
      if (axisId && data.map(function (item) {
        ...
        // eslint-disable-next-line
        process.env.NODE_ENV !== 'production' && console.warn('LineChart: No data found with axisId ' + axisId);
        return null;
      }
      ...
      var gradientKey = typeof dataKey === 'string' ? dataKey.split(' ').join('') : dataKey;
      var getAxis = function getAxis() {
        return !axisId ? inheritedScale : yScale;
      };
      var findFill = function findFill(gradient) {
        return gradient ? 'url(#gradient' + gradientKey + ')' : 'url(#dlines' + gradientKey + ')';
      };
      return _react2.default.createElement(
        ...
        !nofill && _react2.default.createElement(
          _react.Fragment,
          null,
          _react2.default.createElement(_styledComponents.StyledGradient, { opacity: gradientOpacity, color: color, id: 'gradient' + gradientKey }),
          _react2.default.createElement(_styledComponents.StyledPatternLines, { color: color, id: 'dlines' + gradientKey })
        ),
