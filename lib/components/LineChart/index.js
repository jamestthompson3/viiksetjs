  ...
  _createClass(LineChart, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['data', 'color', 'dataKey', 'xScale', 'nofill', 'height', 'margin', 'nopattern', 'inheritedScale', 'axisId']);
      ...
      return React.createElement(
        ...
        !nofill && React.createElement(
          Fragment,
          null,
          React.createElement(StyledAreaClosed, _extends({ data: data, color: color }, {
            y: yPoints,
            x: xPoints,
